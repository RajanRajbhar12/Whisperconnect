...
import { initializeCall, leaveCall } from "@/lib/daily";
...
const VoiceCallScreen = () => {
  ...
  useEffect(() => {
    ...
    async function setupCall() {
      try {
        // Create and join the Daily.co room
        const callFrame = await initializeCall(roomName);
    ...
    return () => {
      ...
      if (callFrameRef.current) {
        leaveCall(callFrameRef.current);
      }
    };
            ...
            >
              ...
              <div className="relative flex space-x-4 items-center">
                ...
                <div id="audio-visualizer" className="flex items-center space-x-1">
                  <div className="audio-visualizer-bar" style={{ height: "2rem" }}></div>
                  <div className="audio-visualizer-bar" style={{ height: "4rem", animationDelay: "0.1s" }}></div>
                  <div className="audio-visualizer-bar" style={{ height: "3rem", animationDelay: "0.2s" }}></div>
                  <div className="audio-visualizer-bar" style={{ height: "5rem", animationDelay: "0.15s" }}></div>
                  <div className="audio-visualizer-bar" style={{ height: "2.5rem", animationDelay: "0.25s" }}></div>
                </div>
              </div>
            </div>
          </div>
